...
Tags: html in url, html to pages, extension, extensions, ext, pages, html on pages, html extension, permalink, .html, .html extension
...
== Screenshots ==
1. .html extension added to page URL.
